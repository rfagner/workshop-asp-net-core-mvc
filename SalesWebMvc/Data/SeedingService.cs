...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        /// <summary>
        /// Método responsável por popular o banco de dados || Method responsible for populating the database
        /// </summary>
        public void Seed()
        {
            // O Any() - Verifica se já tem algum dado na Base de Dados da aplicação
            // The Any() - Checks if there is already some data in the application's Database
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any())
            {
                return; // O banco de dados já foi populado || DB has been seeded
            }
